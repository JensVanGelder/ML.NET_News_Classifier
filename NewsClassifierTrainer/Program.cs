...
namespace NewsClassifierTrainer
{
    internal class Program
    {
        ...
        private static void TrainTheModelWithUnbalancedData()
        {
            ...
            IDataView trainingDataView = GetTrainingDataView(mlContext, unbalancedDataFile);
            ...
            Console.WriteLine();
            Console.WriteLine("Cross validation Metrics for model");
            Console.WriteLine("-----------------------------------");
            ...
            Console.WriteLine($"Model training finished in {(DateTime.Now - startingTime).TotalSeconds}");
            Console.WriteLine();
        ...
        private static void TrainTheModel()
        {
            ...
            var trainingDataPath = "Data\\uci-news-aggregator.csv";
            IDataView trainingDataView = GetTrainingDataView(mlContext, trainingDataPath);
        ...
        private static IDataView GetTrainingDataView(MLContext mlContext, string trainingDataPath)
        {
